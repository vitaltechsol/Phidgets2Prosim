...
- [Phidgets Inputs](#phidgets-input)
- [Phidgets Multi-Inputs](#phidgets-multi-inputs)
- [Phidgets Output](#phidgets-output)
- [Phidgets Gates](#phidgets-gates)
- [Phidgets Audio Gates](#phidgets-audio-gates)
- [Phidgets BL DC Motors](#phidgets-bl-dc-motors)
- [Phidgets Voltage Outputs (For gauges)](#phidgets-voltage-output)
- [Phidgets Voltage Input (For pots)](#phidgets-voltage-input)
- [Custom Trim Wheel](#custom-trim-wheel)
- [Phidgets Buttons](#phidgets-button)
...
*Voltage ratio input is used here**
