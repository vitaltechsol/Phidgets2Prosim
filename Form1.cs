				...
				if (config.CustomParkingBrakeInstance != null)
				{
					...
					try
					{
						var pb = new Custom_ParkingBrake(
							...
							releaseToeBrakeThreshold: c.ReleaseToeBrakeThreshold,
							releaseVariable: c.ReleaseVariable,
							releaseDelayOnMs: c.ReleaseDelayOnMs,
							releaseMaxTimeOnMs: c.ReleaseMaxTimeOnMs
						); ;
