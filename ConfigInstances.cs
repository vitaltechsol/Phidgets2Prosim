...
namespace Phidgets2Prosim
{
	...
	public class CustomParkingBrakeInst
	{
		...
		// Toe brake value above which the parking brake will ENGAGE (given switch on).
		public int ToeBrakeThreshold { get; set; } = 700;

		// Toe brake value above which the parking brake will RELEASE (given it's set).
		public int ReleaseToeBrakeThreshold { get; set; } = 900;

		// VariableManager variable pulsed to perform the release action - same
		public string ReleaseVariable { get; set; }
		public int ReleaseDelayOnMs { get; set; } = 50;
		public int ReleaseMaxTimeOnMs { get; set; } = 1000;
	}
